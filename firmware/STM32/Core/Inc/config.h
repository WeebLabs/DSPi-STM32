...
#define PLATFORM_STM32H723          2     /* STM32H723VGT6 port (M7a+) */

/* DSPI_PLATFORM resolves to the running platform's ID at compile time —
 * vendor_commands.c returns this from REQ_GET_PLATFORM. */
#if defined(STM32H723xx)
#  define DSPI_PLATFORM            PLATFORM_STM32H723
#elif PICO_RP2350
#  define DSPI_PLATFORM            PLATFORM_RP2350
#else
#  define DSPI_PLATFORM            PLATFORM_RP2040
#endif
